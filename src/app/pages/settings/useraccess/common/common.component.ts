...
export class CommonComponent implements OnInit {
  ...
  navItems: NavItem[] = [
    {
      name: 'Users',
      link: '/pages/settings/useraccess/users'
    },
    {
      name: 'User Roles Access',
      link: '/pages/settings/useraccess/user-roles-access'
    },
    {
      name: 'User Roles',
      link: '/pages/settings/useraccess/user-roles'
    },
    {
      name: 'User Functions',
      link: '/pages/settings/useraccess/user-functions'
    },
  ];
