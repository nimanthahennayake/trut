...
const _trutPhoneInputMixinBase: typeof trutPhoneInputBase = mixinErrorState(
  trutPhoneInputBase as _AbstractConstructor<any>,
)
...
export class PhoneInputComponent
  extends _trutPhoneInputMixinBase
